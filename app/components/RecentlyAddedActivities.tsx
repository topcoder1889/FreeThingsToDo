  ...
  const [activities] = useState<Activity[]>([
    {
      ...
      rating: 4.8,
      reviewCount: 87,
      imageUrl: 'https://images.unsplash.com/photo-1518391846015-55a9cc003b25?q=80&w=3000&auto=format&fit=crop'
    },
    {
      id: '2',
      ...
      rating: 4.9,
      reviewCount: 124,
      imageUrl: 'https://images.unsplash.com/photo-1549144511-f099e773c147?q=80&w=3000&auto=format&fit=crop'
    },
    {
      id: '3',
      title: 'Shibuya Crossing Experience',
      description: 'Experience the famous Shibuya Crossing and explore the vibrant surrounding area.',
      location: 'Tokyo, Japan',
      rating: 4.7,
      reviewCount: 56,
      imageUrl: 'https://images.unsplash.com/photo-1513635269975-59663e0ac1ad?q=80&w=3000&auto=format&fit=crop'
    }
  ]);
  ...
  return (
    <section>
      <div className="container">
        <div className="mb-16">
          <h3 className="text-[2.2rem] font-semibold mb-4 tracking-[0.5px]">Recently Added Activities</h3>

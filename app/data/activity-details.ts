...
const activities: Record<string, ActivityDetail> = {
  'san-mateo-county-history-museum': {
    ...
    subtitle: 'Explore the rich heritage of the Peninsula in a magnificent 1910 courthouse building',
    ...
    highlights: [
      {
        ...
        icon: '🏛️',
        title: 'Courtroom A',
        description: 'A meticulously restored 1910 courtroom with original furnishings that offers visitors a glimpse into the early 20th-century justice system.'
      },
      {
        id: '2',
        icon: '🚂',
        title: 'Transportation Gallery',
        description: 'Exhibits detailing how transportation shaped the county\'s development, from stagecoaches to railways and the impact of automobiles.'
      },
      {
        id: '3',
        icon: '👑',
        title: 'The Atkinson Dome',
        description: 'A stunning stained glass dome that crowns the rotunda and creates a dramatic architectural focal point.'
      },
      {
        id: '4',
        icon: '🏢',
        title: 'Living History',
        description: 'Interactive exhibits that recreate historic businesses, including a general store, a barbershop, and other establishments from the county\'s past.'
      }
    ],
    rating: {
      overall: 4.7,

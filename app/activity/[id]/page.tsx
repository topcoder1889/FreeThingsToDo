...
export default function ActivityPage() {
  ...
  const activityTitle = params.id as string;
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="container mx-auto px-4 py-4">
          <div className="flex gap-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <Link href="/countries" className="hover:text-primary">USA</Link>
            <span>/</span>
            <Link href="/country/usa" className="hover:text-primary">California</Link>
            <span>/</span>
            <Link href="/city/redwood-city" className="hover:text-primary">Redwood City</Link>
            <span>/</span>
      ...
      <section className="relative h-[60vh] min-h-[500px] bg-cover bg-center" style={{ backgroundImage: `linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('/api/placeholder/1200/600')` }}>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl text-white">
              ...
              <div className="flex gap-4">
                <a href="#map" className="btn btn-primary">Get Directions</a>
                <a href={activity.info.website} target="_blank" className="btn btn-outline">Visit Website</a>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="bg-white rounded-xl p-8 mb-8">
                ...
                <div className="flex items-center gap-8 mb-8">
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-600">Based on {activity.rating.reviewCount} reviews</div>
                  </div>
                      ...
                      <div className="flex justify-between items-start mb-4">
                        <div className="flex items-center gap-4">
                          <div className="w-12 h-12 rounded-full bg-gray-200 overflow-hidden">
                            <Image src={review.reviewerAvatar} alt={review.reviewerName} width={48} height={48} />
                          </div>
                          <div>
                  ...
                  {activity.nearbyAttractions.map((attraction) => (
                    <div key={attraction.id} className="flex gap-4 bg-gray-50 rounded-lg p-4">
                      <div className="w-20 h-20 rounded-lg overflow-hidden">
                        <Image src={attraction.imageUrl} alt={attraction.title} width={80} height={80} />
                      </div>
                      <div>
            ...
            <div className="space-y-8">
                ...
                <div className="p-6">
                  <ul className="space-y-4">
                    ...
                    <li>
                      ...
                      <a href={activity.info.website} target="_blank" className="font-medium text-primary hover:underline">
                        {activity.info.website}
                      </a>
                    </li>
                    <li>
                      <span className="text-sm text-gray-600 block">Opening Hours</span>
                      <span className="font-medium whitespace-pre-line">{activity.info.openingHours}</span>
                    </li>
                    <li>
                      <span className="text-sm text-gray-600 block">Admission</span>
                      <span className="font-medium whitespace-pre-line">{activity.info.admission}</span>
                    </li>
                    <li>
              ...
              <div id="map" className="bg-white rounded-xl overflow-hidden">
                ...
                <div className="h-64 bg-gray-200">
                  <Image src="/api/placeholder/600/400" alt="Map" width={600} height={400} className="w-full h-full object-cover" />
                </div>
                <div className="p-4">
                  <p className="font-medium mb-2">{activity.info.address}</p>
                  <p className="text-sm text-gray-600 mb-4">
                    Located in the historic courthouse in downtown Redwood City, at the corner of Broadway and Hamilton Street.
                  </p>
                  <a
